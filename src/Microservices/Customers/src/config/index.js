...
module.exports = {
    ...
    HEARTLANDSERVICEURL: process.env.HEARTLANDSERVICEURL,
    HEARTLANDUSERNAME: process.env.HEARTLANDUSERNAME,
    HEARTLANDAPIPASSWORD: process.env.HEARTLANDAPIPASSWORD,
    HEARTLANDMERCHANTNAME: process.env.HEARTLANDMERCHANTNAME,
    HEARTLANDTOKENURL: process.env.HEARTLANDTOKENURL
}